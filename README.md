...
Crafters who like to be social.

  I wanted a simple design easy to read and navigate but who's images, layout, design and text all convey that it is a fun, enjoyablke atmosphere, with an inclusivivity at the forefront. People can see the months craft focus, watch a tutorial and book to join for whatever date that suits. The navigation and site is simple to allow for creative people of all ages who may not be tech savy.

**Site Goals:**

The goal of the site is to act as a community hub of information for its members or visitors where they can 
* Clearly see what craft the members are focusing on
* Cleary see what bespoke cocktail has been designed for them this month
* Book their spot on a chosen date
* Use as a source of inspiration and pride - through sharing members past work
* Use as a source of knowledge - with a monthly how to video on the chosen topic and a site that captures the spirit of the group. 
* Clearly see fun free and welcoming atmosphere to attract new members.
...
They are elegent yet not too serious and easily readable with the styled letter spacing.
...
**Wireframes:**
  ...
  * Once I saw the Join Us page on a larger screens I decided to play around with the visual order to create balance.
____
## FEATURES:
...
**Lighthouse**
* Mobile Pages:
    * ![](assets/readme-images/lh-mobile-home.png)
        ![](assets/readme-images/lh-mobile-gallery.png)
        ![](assets/readme-images/lh-mobile-join.png)
* Desktop Pages:
    * ![](assets/readme-images/lh-desktop-home.png)
    ![](assets/readme-images/lh-desktop-gallery.png)
    ![](assets/readme-images/lh-desktop-join.png)
## DEPLOYMENT:
...
* Change the styling of welcome text to make it easier for dyslexic readers.
___

## CREDITS:

**Code:**  
  I used a variety of sources starting with the Love Running project but adapted to suit my project, styling and design choices. I relied heavily on dev tools to adapt code and problem solve.

* Love running example was used for the following as a base:
...
* Footer:
    * style using the nav bar info along with flexbox froggy to style.
